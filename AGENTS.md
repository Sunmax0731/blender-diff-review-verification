...
この repo は `blender-diff-review-verification` の closed alpha 実装単位です。

## Scope

- Root: `D:\AI\BlenderAddon\blender-diff-review-verification`
- Domain: BlenderAddon
- Product kind: blender-addon
- Source pack: `D:/AI/BlenderAddon/created_idea_004_blender-diff-review-verification/idea_004_blender-diff-review-verification.zip`
- Public repo: `https://github.com/Sunmax0731/blender-diff-review-verification`

## Working Rules

- README、AGENTS、SKILL、docs を同じ変更単位で更新する。
- created_idea は `D:/AI/BlenderAddon/created_idea_004_blender-diff-review-verification` を正とし、同梱 ZIP の `metadata.json` と repo 名が一致することを確認する。
